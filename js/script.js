...
async function getsongs(folder) {
    ...
    for (const song of songs) {
        songUL.innerHTML += `
            <li>
                <img class="invert musiclogo" src="./img/music-note-03-stroke-standard.svg" alt="music-note-03" width="32" height="32">
                <div class="info">
                    <div>${song.replaceAll("%20", " ")}</div>
                </div>
                <div class="playnow">
        ...
        if (e.href.includes("/songs")) {
            ...
            cardcontainer.innerHTML += `
                <div data-folder="${folder}" class="card">
                    ...
                    <img src="songs/${folder}/cover.jpg" alt="cover" loading="eager">
                    <h2>${data.title}</h2>
...
async function main() {
    ...
    document.querySelector(".volume input").addEventListener("input", (e) => {
        ...
        document.querySelector(".volume > img").src =
            volume > 0 ? "./img/volume-high-stroke-standard.svg" : "./img/volume-mute-02-stroke-standard.svg";
    });
